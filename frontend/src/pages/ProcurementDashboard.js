            ...
            <CardContent className="p-0">
              {(() => {
                ...
                let allDisplayOrders = filteredOrders.filter(order => {
                  ...
                  if (ordersViewMode === "gm_approved_pending") return order.status === "pending_procurement_confirmation";
                                ...
                                <div className="flex gap-1 justify-center">
                                  ...
                                  {order.status === "pending_procurement_confirmation" && (
                                    <Button 
                                      size="sm" 
                                      variant="ghost" 
                                      onClick={() => confirmProcurementOrder(order)} 
                                      className="h-8 px-2 text-xs bg-indigo-100 hover:bg-indigo-200 text-indigo-700"
                                      title="تأكيد الأمر"
                                    >
