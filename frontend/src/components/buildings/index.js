/**
 * Buildings Components Index
 * فهرس مكونات نظام المباني
 */

export { default as BuildingsDashboard } from './BuildingsDashboard';
export { default as BuildingsTemplates } from './BuildingsTemplates';
