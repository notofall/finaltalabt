...
### P2 - أولوية متوسطة
- [ ] إصلاح خلل UI: اسم المادة لا يتحدث عند إضافة مادة ثانية للقالب
- [ ] استيراد معاملات المواد من ملف "دليل_مواد_البناء_الكود_السعودي.xlsx"
- [ ] إكمال إعادة هيكلة BuildingsSystem.js (2285 سطر) - استخدام المكونات الموجودة في `/components/buildings/`
